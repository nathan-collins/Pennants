				...
				<form name="AddGradeForm" class="form-horizontal" role="form">
					...
					<fieldset style="margin-bottom:10px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" ng-model="grade.settings_players" ng-value="<% grade.settings.players %>" grade-settings-players />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-10 control-label">What is the maximum number of reserve players for each match?</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" placeholder="" ng-model="grade.settings_reserves" ng-value="<% grade.settings.reserves %>" />
							</div>
						</div>
						<div class="form-group">
