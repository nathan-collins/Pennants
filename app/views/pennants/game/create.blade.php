						...
						<div class = "col-sm-10">
							<p class = "input-group">
								<input type = "text" class = "form-control" datepicker-popup = "<% format %>"
											 id = "game-input-game-data" ng-model = "game.game_date" is-open = "opened" min = "minDate"
											 max = "'maxDate'" datepicker-options = "dateOptions" date-disabled = "disabled(date, mode)"
					...
					<div class = "form-group">
						<div class = "col-sm-offset-2 col-sm-10">
							<button type = "submit" class = "btn btn-default"
											ng-disabled = "AddGameForm.$invalid || isUnchanged(club)"
											ng-click = "addGame(game)">Submit</button>
						</div>
					</div>
				</form>
			</div>
